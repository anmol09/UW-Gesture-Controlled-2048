...
public class LineGraphView extends View
{
	...
	public final int[] defalutColors ={0xff00aedb,
										0xffa200ff,
										0xffd41243,
										0xff000000,
										0xffffff00,
	...
	private final int AXIS_WIDTH = 130;
	...
	private void prepForData(Canvas canvas)
	{
		...
		/**
		 * HOW TO CHANGE THE AXIS COLOUR AND SIZE OF LEGEND
		 */
		graphPaint.setColor(0xffffffff);
		graphPaint.setTextSize(16);
		
		canvas.drawText(Float.toString(maxY) + " m/s^2", 0, 15, graphPaint);
